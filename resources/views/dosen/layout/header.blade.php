            ...
            <ul>
                <li class="relative px-6 py-3   {{ $active === 'rentanFuzzy' ? 'bg-white dark:bg-gray-700 rounded-lg shadow-md' : '' }}">
                    ...
                    <a
                        ...
                        href="{{ route('fuzzyRange.dosen.index') }}"
                    >
                        <svg
                            class="w-5 h-5"
                            aria-hidden="true"
                ...
                <li class="relative px-6 py-3 {{ $active === 'inference' ? 'bg-white dark:bg-gray-700 rounded-lg shadow-md' : '' }}">
                  ...
                  <a
                      ...
                      href="{{ route('inference_rule.dosen.index') }}"
                  >
                      <svg
                          class="w-5 h-5"
                          aria-hidden="true"
                ...
                >
                  ...
                  <div class="w-full flex justify-end">
                    <ul class="flex justify-end flex-shrink-0 space-x-6">
                      <!-- Theme toggler -->
                      <li class="flex">
                        <p class="text-md font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">Selamat datang, {{ $user->name }}</p>
                      </li>
                      <li class="flex">
                        <button
