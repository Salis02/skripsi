...
@section('container')
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container mx-auto mt-4">
            <h2 class="text-2xl font-bold">Edit Transkrip</h2>
            ...
            <form action="{{ route('transkrip.update', $transkrip->id) }}" method="POST" class="mt-4">
                @csrf
                @method('PUT')
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" step="0.01" name="nilai_akhir" id="nilai_akhir" class="w-full border rounded p-2" value="{{ $transkrip->nilai_akhir }}" readonly>
                </div>

                <div class="mb-4">
                    <label for="nilai" class="block text-sm">Nilai:</label>
                    <input type="text" name="nilai" id="nilai" class="w-full border rounded p-2" value="{{ $transkrip->nilai }}">
                </div>
                <div class="mb-4">
