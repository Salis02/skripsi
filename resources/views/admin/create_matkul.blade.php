...
<form action="{{ route('matkul.store') }}" method="POST" class="px-4 py-3 mb-8 bg-gray-100 rounded-lg shadow-md dark:bg-gray-800">
    ...
    <div class="mb-4">
        ...
        <input type="number" name="teori" id="teori" value="{{ old('teori') }}" oninput="calculateTotalSKS()" required class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
    </div>
    <div class="mb-4">
        <label class="block text-gray-700 dark:text-gray-400 text-sm font-bold mb-2" for="praktek">Praktek (SKS):</label>
        <input type="number" name="praktek" id="praktek" value="{{ old('praktek') }}" oninput="calculateTotalSKS()" required class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
    </div>
    <div class="mb-4">
