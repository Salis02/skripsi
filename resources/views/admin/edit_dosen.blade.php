...
<div class="container mx-auto mt-4">
    ...
    <form action="/admin/dosen/{{ $dosen->id }}" method="POST" class="px-4 py-3 bg-gray-100 rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div class="mb-4">
            ...
            <input type="password" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" name="password" id="password" required>
        </div>
