...
<div class="bg-white mt-4 px-2 rounded-lg dark:bg-gray-700">
    ...
    <div class="w-full mt-2 overflow-hidden rounded-lg">
        @if ($dosens->count() > 0 || $mahasiswas->count() > 0)
            <div class="mb-4">
                @if ($dosens->count() > 0)
            ...
            @if ($mahasiswas->count() > 0)
                ...
                <div class="w-full overflow-x-auto shadow-md">
                        <table class="w-full whitespace-wrap text-md">
                            <thead>
                                <tr class="text-l font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                    <th class="px-4 py-3" scope="col">No.</th>
        ...
        @else
            <p>Mahasiswa/dosen tidak ditemukan.</p>
        @endif
    </div>
</div>        
